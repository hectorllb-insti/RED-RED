...
const StoryViewerModal = ({ story, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg mx-4 h-[80vh] flex flex-col">
        <button
          onClick={onClose}
